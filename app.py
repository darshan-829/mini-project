...
bowler_list = ['YS Chahal', 'PP Chawla', 'DJ Bravo', 'B Kumar', 'R Ashwin', 'SP Narine', 'A Mishra', 'SL Malinga', 'JJ Bumrah', 'RA Jadeja', 'Harbhajan Singh', 'Rashid Khan', 'UT Yadav', 'Sandeep Sharma', 'HV Patel', 'MM Sharma', 'Mohammed Shami', 'AR Patel', 'TA Boult', 'K Rabada', 'AD Russell', 'A Nehra', 'R Vinay Kumar', 'Z Khan', 'JD Unadkat', 'CH Morris', 'SN Thakur', 'Mohammed Siraj', 'I Sharma', 'Kuldeep Yadav', 'DS Kulkarni', 'CV Varun', 'Imran Tahir', 'DL Chahar', 'KV Sharma', 'Arshdeep Singh', 'KH Pandya', 'RD Chahar', 'Avesh Khan', 'KK Ahmed', 'KA Pollard']
    ...
    with col112:
        ...
        with col20:
            try:
                ...
                try:
                    is_series_100 = player_no_of_100.shape[1]
                except:
                    is_series_100 = 1
            except:
                ...
                century_hai = 1
                if is_series_100 == 1:
                    st.metric("Centuries", str(player_no_of_100['batsman_runs']))
                else:
